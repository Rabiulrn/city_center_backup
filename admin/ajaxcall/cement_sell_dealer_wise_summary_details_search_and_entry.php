...
$sucMsg = "";
$total_weight = 0;
$sql = "SELECT SUM(weight) as weight FROM details_sell_cement WHERE particulars LIKE '%Cement (Cem3)-Gold%' AND dealer_id = '$dealerId' AND project_name_id = '$project_name_id'";
...
$total_weight1 = 0;
$sql = "SELECT SUM(weight) as weight FROM details_sell_cement WHERE particulars LIKE '%Cement (OPC)-1%' AND dealer_id = '$dealerId' AND project_name_id = '$project_name_id'";
$result = $db->select($sql);
if($result->num_rows > 0){
    while($row = $result->fetch_assoc()){
...
$total_weight2 = 0;
$sql = "SELECT SUM(weight) as weight FROM details_sell_cement WHERE particulars LIKE '%Cement Poly (PCC)-1%' AND dealer_id = '$dealerId' AND project_name_id = '$project_name_id'";
$result = $db->select($sql);
if($result->num_rows > 0){
    while($row = $result->fetch_assoc()){
...
$total_weight3 = 0;
$sql = "SELECT SUM(weight) as weight FROM details_sell_cement WHERE particulars LIKE '%Cement Poly (PCC)-2%' AND dealer_id = '$dealerId' AND project_name_id = '$project_name_id'";
$result = $db->select($sql);
if($result->num_rows > 0){
    while($row = $result->fetch_assoc()){
...
<table width="100%" class="summary">
    <tr>
      <!-- <td class="hastext" width="150px"></td>
